...
//[[10], [20, 20], [30, 30, 30], [40, 40, 40, 40], [50, 50, 50, 50, 50]] //fo문은
//        arr2의 길이만큼 간건데 왜 50까지밖에 출력이 안되는지?

//        //배열 뒤집기 //뒤집은 값을 신규 배열에 답은후 선언
        int[] arr3 = {1, 2, 3, 4, 5}; //이거 코드 이상해
        //신규배열 선언 : arr2
        int[] arr4 = new int[arr3.length];
        for (int i = 0; arr3.length > i; i++) {
            arr3[arr4.length - 1 - i] = arr3[i];
        }
