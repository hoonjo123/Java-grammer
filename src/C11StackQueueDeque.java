...
//        //ArrayDeque 는 양방향에서 데이터를 삽입/제거 할 수 있다. 성능이 빠르다.
//        myDeque.addFirst(10);
//        myDeque.addFirst(20); //20,10 앞에다가 밀어넣는 형식
//        System.out.println(myDeque); //[20, 10]
//        myDeque.addLast(30);
//        System.out.println(myDeque); //[20, 10, 30]
//        System.out.println(myDeque.pollFirst()); //20 꺼내고 버려짐
//        System.out.println(myDeque.pollLast()); //30 꺼내고 버려짐
//        System.out.println(myDeque); // 10만 남음
//
//        //올바른 괄호
        //()()      true;
        //"(())()"	true;
        ...
        //"(()("	false;
        //열고 닫고의 관계가 명확해야한다.
        //올바른 괄호면 true 올바르지 않으면 false
//        Stack<String> myst = new Stack<>();
//        String s = "()()";
//        int open = 0;
//        int close = 0;
...
//           myDeq.addFirst(String.valueOf(a.charAt(i)));
//        }
//
//        while(!myDeq.isEmpty()){
//            if(myDeq.pollFirst().equals(")")){
//                System.out.println(false);
//                break;
//        }
//            System.out.println(myDeq.pollFirst());
//            System.out.println(myDeq.pollLast());
//        }
//        // 처음 뽑았을 때 )가 있으면 false를 리턴한다
///
